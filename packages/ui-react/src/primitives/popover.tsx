	...
	return (
		<AriaPopover
			...
			className={composeRenderProps(className, (className) => {
				return cn(
					[
						"min-w-[var(--ui-trigger-width,_var(--trigger-width))] overflow-hidden rounded-sm border border-stroke-weak bg-background-overlay text-text-strong shadow-overlay",
